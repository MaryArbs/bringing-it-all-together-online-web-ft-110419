class Dog
 ...
 def self.drop_table
  ...
  def self.create(attributes) # takes in a hash of attributes and uses metaprogramming to create a new dog object. Then it uses the #save method to save that dog to the database
